...
def create_draw_frame(canvas, frame):
    ...
    clear_button = customtkinter.CTkButton(frame, text="Finish", command=lambda: finish_draw())
    clear_button.pack(pady=10)
    ...
    canvas.bind("<ButtonRelease-1>", lambda event: [end_draw(event)])
